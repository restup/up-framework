...
/**
 * Interface which provides a suggested approximation for resource service operations.
 * Implementing the interface is not required and signature of these methods can vary when using annotations
 *
 * @param <T>
 * @param <ID>
 * @author abuttaro
