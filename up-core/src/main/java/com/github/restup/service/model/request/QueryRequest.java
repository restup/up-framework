...
/**
 * Defines required fields for query operations, providing
 * query criteria for list operations or targeted updates or deletes
 *
 * @author abuttaro
 */
public interface QueryRequest {
    ...
    /**
     * Includes requests for secondary data related to the primary requests
     * results.
     *
     * @return
     */
