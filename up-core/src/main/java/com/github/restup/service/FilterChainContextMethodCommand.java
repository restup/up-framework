...
/**
 *
 * {@link IndexedVarArgsMethodCommand} which obtains method arguments at runtime
 * from a {@link FilterChainContext} index.
 *
 * The command is expected to be executed with the FilterChainContext as a first
 * argument, all other arguments are ignored.  The arguments for the
 * {@link #method} invoked are obtained by index using {@link FilterChainContext#getArgument(int)}
 *
 * @author andy.buttaro
 */
