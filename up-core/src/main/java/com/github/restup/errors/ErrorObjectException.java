...
public class ErrorObjectException extends RuntimeException {
    ...
    /**
     * @return the greatest httpStatus from all errors in this exception, or 500 if none.
     */
    public int getHttpStatus() {
        ...
        return ErrorBuilder.ErrorCodeStatus.INTERNAL_SERVER_ERROR.getHttpStatus();
    }
