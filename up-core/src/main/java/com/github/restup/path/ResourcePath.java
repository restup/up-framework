...
/**
 * Provides support for accessing and representing fields of an object or object graph.
 */
public class ResourcePath implements ErrorSource {
    ...
    public Object getValue(Object instance) {
        ...
        ResourcePath current = first();
        //XXX cheating here using ResourceData... should see if object has a data property
