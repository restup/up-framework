...
/**
 * Simply throws an unsupported media type error. May be added to {@link RequestParserChain} as last item to handle request if none others do (default behavior)
 */
