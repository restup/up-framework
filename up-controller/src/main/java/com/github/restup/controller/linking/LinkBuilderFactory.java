...
/**
 * A factory for providing {@link LinkBuilder} implementations
 * which may be configured using {@link ControllerSettings.Builder#linkBuilderFactory(LinkBuilderFactory)}
 */
public interface LinkBuilderFactory {

    /**
     * The resulting {@link LinkBuilder} could be implemented as singleton, thread safe or accept the arguments
