...
//            }
            ...
            // ex 3. foos/ids/relationships/bars ; get a to many relationship
            // ex 4. foos/ids/relationships/bar  ; get a to one relationship
            // ex 5. foos/resourceActions ; execute a resource action //TODO
            // ex 6. foos/ids/bars/ids/bazs ; get deep relationship //TODO
            // non json api stuff you need to do with composite keys
            // /foos/1/bars/1
            // /foos/1/2 (composite key)
            ...
            if (idString != null) {
                Type type = resource.getIdentityField()[0].getType();
