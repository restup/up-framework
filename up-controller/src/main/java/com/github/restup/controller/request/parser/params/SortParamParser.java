...
/**
 * Parses a parameter of delimited field names specifying sort order. ','
 * delimited and named sort by default. By default sort order is ascending, but
 * can be changed by using '-' prefix ahead of a field name
 * <p>
 * <p>
