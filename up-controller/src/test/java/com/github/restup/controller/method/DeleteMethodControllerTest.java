...
public class DeleteMethodControllerTest {
    ...
    public void testGetRequest() {
        ...
        DeleteStrategySupplier strategy = mock(DeleteStrategySupplier.class);
        ...
        ParameterProvider request = (ParameterProvider) m
            .getRequest(mock(Resource.class), null, null, details, strategy);
